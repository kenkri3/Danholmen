    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 pt-6 pb-4 min-h-[72px]">
          <FlameIcon className="w-6 h-6 text-warm-amber flex-shrink-0" />
          <AnimatePresence>
            {(!collapsed || mobileOpen) && (
              <motion.span
                ...
                exit={{ opacity: 0, x: -10 }}
                transition={{ duration: 0.2 }}
                className="font-display text-[22px] font-bold text-white whitespace-nowrap overflow-hidden"
              >
                Danholmen
              </motion.span>
            )}
            ...
            return (
              ...
              >
                {isActive && (
                  <motion.div
                    layoutId="activeNav"
                    className="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-6 bg-warm-amber rounded-r-full"
                  />
                )}
