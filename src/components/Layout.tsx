        ...
        <header className="h-16 bg-white border-b border-[#DDD6CC] flex items-center justify-between px-3 sm:px-4 md:px-6 xl:px-8 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-2 md:gap-4 xl:gap-6 flex-shrink-0">
            ...
            <Popover open={open} onOpenChange={setOpen}>
              <PopoverTrigger asChild>
                <button className="relative p-2 rounded-lg text-text-secondary hover:bg-off-white transition-colors touch-target flex items-center justify-center">
                  ...
                  {pendingCount > 0 && (
                    <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-warm-amber rounded-full" />
                  )}
                </button>
              </PopoverTrigger>
              <PopoverContent
                  ...
                  {pendingCount === 0 ? (
                    ...
                    pendingBookings.map((booking) => {
                      ...
                      return (
                        ...
                        >
                          <Calendar className="w-4 h-4 text-warm-amber mt-0.5 flex-shrink-0" />
                ...
                {pendingCount > 0 && (
                  <div className="px-4 py-2 border-t border-[#F5F0EB]">
                    <button
                      ...
                      className="text-xs text-warm-amber hover:text-amber-deep font-medium transition-colors"
                    >
            ...
            <button
              ...
              className="flex items-center gap-2 bg-warm-amber hover:bg-amber-light text-white text-sm font-medium px-3 py-2 rounded-lg shadow-amber-btn hover:shadow-amber-btn-hover hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 touch-target"
            >
