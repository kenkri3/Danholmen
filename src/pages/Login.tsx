    ...
    <div className="min-h-[100dvh] flex">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-end p-12 h-full">
          ...
          <div className="w-10 h-[2px] bg-warm-amber mb-4" />
                  ...
                  >
                    <button
                      ...
                      className={`w-full h-12 rounded-lg text-white text-base font-medium transition-all duration-200 flex items-center justify-center gap-2 ${
                        success
                          ? "bg-success"
                          : "bg-warm-amber hover:bg-amber-light shadow-[0_4px_16px_rgba(212,134,60,0.3)] hover:shadow-[0_6px_24px_rgba(212,134,60,0.4)] hover:scale-[1.01] active:scale-[0.98]"
              ...
              >
                ...
                <form onSubmit={handleForgot} className="mt-10 space-y-5">
                  ...
                  <button
                    ...
                    className="w-full h-12 rounded-lg bg-warm-amber hover:bg-amber-light text-white text-base font-medium shadow-[0_4px_16px_rgba(212,134,60,0.3)] hover:shadow-[0_6px_24px_rgba(212,134,60,0.4)] hover:scale-[1.01] active:scale-[0.98] transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
                        <Loader2 className="w-4 h-4 animate-spin" />
