...
const PIE_COLORS = ["#EE4C84", "#1A6B7C", "#7C3AED"];
...
export default function Reports() {
  ...
  const [selectedSaunas] = useState<string[]>(["all"]);
    ...
    >
      <PageHeader
        ...
        action={
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-brand-pink text-white text-sm font-medium hover:bg-pink-light transition-colors shadow-amber-btn"
          >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          ...
          {/* Column 3 — Campaign Stats */}
          <div>
            <label className="text-xs font-medium uppercase tracking-[0.06em] text-text-secondary mb-3 block">
              Kampanjer & Rabattkoder
            </label>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 rounded-xl border border-[#DDD6CC] bg-[rgba(26,107,124,0.04)]">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-teal/10 flex items-center justify-center">
                    <Megaphone className="w-4 h-4 text-teal" />
                  </div>
                  <div>
                    <p className="text-sm font-medium text-text-primary">Aktive kampanjer</p>
                    <p className="text-[10px] text-text-muted">Pågående kampanjer</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-xl border border-[#DDD6CC] bg-[rgba(238,76,132,0.04)]">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-brand-pink/10 flex items-center justify-center">
                    <Tag className="w-4 h-4 text-brand-pink" />
                  </div>
                  <div>
                    <p className="text-sm font-medium text-text-primary">Aktive rabattkoder</p>
                    <p className="text-[10px] text-text-muted">Gjeldende koder</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-xl border border-[#DDD6CC]">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-[#EDE7DE] flex items-center justify-center">
                    <Users className="w-4 h-4 text-text-secondary" />
                  </div>
                  <div>
                    <p className="text-sm font-medium text-text-primary">Brukte rabattkoder</p>
                    <p className="text-[10px] text-text-muted">Totalt antall bruk</p>
                  </div>
                </div>
                <span className="text-xl font-bold font-mono text-text-secondary">
                  {discountCodes.reduce((sum, d) => sum + d.usageCount, 0)}
                </span>
              </div>
            </div>
          </div>
        ...
        <button
          ...
          className="w-full mt-5 py-3 rounded-xl bg-brand-pink text-white text-sm font-medium hover:bg-pink-light transition-colors shadow-amber-btn disabled:opacity-40 disabled:cursor-not-allowed"
        >
          Generer rapport
        </button>
      </motion.div>
              ...
              >
                ...
                <ResponsiveContainer width="100%" height={240}>
                  <BarChart data={saunaChartData} barSize={40}>
                    ...
                    />
                    <Bar dataKey="omsetning" fill="#EE4C84" radius={[6, 6, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </motion.div>
              ...
              <DataTable
                columns={[
                  ...
                  },
                  {
                    ...
                    header: "Omsetning",
                    render: (row) => (
                      <span className="font-mono text-sm text-brand-pink font-medium">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <button
              onClick={handleSendNow}
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-brand-pink text-white text-sm font-medium hover:bg-pink-light transition-colors shadow-amber-btn"
            >
