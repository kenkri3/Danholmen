...
const typeColors: Record<DiscountType, string> = {
  ...
  fixed_amount: "bg-brand-pink/10 text-brand-pink",
};
...
const appliesToColors: Record<AppliesTo, string> = {
  ...
  private: "bg-brand-pink/10 text-brand-pink",
          ...
          <button
            ...
            className={cn(
              ...
              discountType === "fixed_amount"
                ...
                : "border-[#DDD6CC] bg-white hover:border-brand-pink/50"
            )}
          >
            ...
            {discountType === "fixed_amount" && (
              <span className="w-5 h-5 bg-brand-pink rounded-full flex items-center justify-center">
                <Check className="w-3 h-3 text-white" />
              </span>
            )}
          </button>
