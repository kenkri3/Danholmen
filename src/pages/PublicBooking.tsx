            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-[#DDD6CC]">
                  ...
                  <button className="flex items-center gap-1 bg-brand-pink hover:bg-pink-light text-white text-sm font-medium px-4 py-2 rounded-lg shadow-amber-btn hover:shadow-amber-btn-hover transition-all duration-200">
                    Book nå
