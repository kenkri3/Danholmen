...
function showToast(message: string, type: "success" | "error" | "info" = "info") {
  ...
  const bgColor = type === "success" ? "#3A9E6F" : type === "error" ? "#C44B6B" : "#1A6B7C";
                    ...
                    {!loggedInMember ? (
                      <div>
                        ...
                        >
                          ...
                          {showLogin
                            ? "Skjul innlogging"
                            : "Er du medlem? Logg inn for rabatt"}
                        </button>
                      ...
                      <div className="flex items-center gap-3 bg-success/10 rounded-xl p-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-text-primary">
                            Innlogget som medlem
                          </p>
                          <p className="text-xs text-text-secondary">
                            {loggedInMember.firstName} {loggedInMember.lastName}{" "}
                            — {Math.round(memberDiscountRate * 100)}% rabatt
                          </p>
                          {loggedInMember.tier && (
                            <span className="inline-block mt-1 px-2 py-0.5 rounded-full text-[10px] font-semibold uppercase tracking-wide bg-deep-teal text-white">
                              {loggedInMember.tier}
                            </span>
                          )}
                        </div>
                        <button
                          ...
                          className="text-xs text-text-muted hover:text-sauna-red transition-colors shrink-0"
                        >
                          Logg ut
                        </button>
                      </div>
                    ...
                    <label className="flex items-start gap-3 cursor-pointer">
                      ...
                      <span className="text-sm text-text-secondary leading-relaxed">
                        ...
                        <button
                          onClick={() =>
                            alert(
                              "Vilkår:\n\n1. Avbestilling må skje minst 24 timer før.\n2. Badstuen må forlates i samme stand som ved ankomst.\n3. Medbrakt alkohol er ikke tillatt.\n4. Ansvarlig voksen må være til stede."
                            )
                          }
                          className="text-teal underline hover:text-deep-teal"
                          type="button"
                        >
                          vilkårene
                        </button>{" "}
